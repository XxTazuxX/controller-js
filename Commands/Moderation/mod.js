      ...
      options: [
        {
          ...
          type: "STRING",
          required: true,
          choices: [{ name: "remove timeout", value: "remove timeout" }],
        },
        {
          name: "member",
          description: "Select the member",
  ...
  async execute(interaction, client) {
    ...
    if (!Data)
      return interaction.reply({
        content:
          "You havn't setup a mod message log yet, Please do this with [/modlogsetup]",
        ephemeral: true,
      });
    ...
    if (!id)
      return interaction.reply({
        content:
          "Possible member already left on there own or something els went wrong",
        ephemeral: true,
      });
